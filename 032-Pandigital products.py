import time
# Method 1: Brute force with limit of 9999 as a 4 digit multiplied by an integer, 1 for example, will result in at least a 4 digit product; therefore a total of at least 9 digits and we need no more
dict1={}
summ=0
start= time.time()
